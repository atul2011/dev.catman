...
<form method="POST" id="item-form" action="/admin/article/edit/<?php echo $article->id; ?>" class="quark-presence-column content-column left">
    <div class="quark-presence-container content-container  main">
        ...
        <div class="quark-presence-column left" id="main_div">
			...
			<div class="cm-form-checkbox"><input type="checkbox" name="new_" id="cm-item-new_" value="<?php echo $article->new_;?>">New</div>
                    </div>
                </div>
            </div>
        </div>
