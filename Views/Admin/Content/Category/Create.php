...
?>
<form method="POST" id="form"  action="/admin/category/<?php echo $service; ?>">
            ...
            <div class="quark-presence-column left" id="main_div">
                ...
                <div class="quark-presence-container presence-block middle category-form-div">
                    <div class="title"><p>Type</p>
                        <input type="text" placeholder="Type" class="quark-input text_field" name="sub"id="sub" value="<?php echo $item->sub; ?>"/>
                    </div>
                </div>
                <div class="quark-presence-container presence-block middle category-form-div">
