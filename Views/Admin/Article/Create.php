...
<form class="quark-presence-column content-column left" method="POST" id="item-form" action="/admin/article/create">
    <div class="quark-presence-container content-container  main">
        <div class="quark-presence-container long-field">
            ...
            <div class="quark-presence-container form-value">
                <input placeholder="Title" type="text" class="quark-input text_field" name="title" id="item-title" value="">
            </div>
        </div>
    ...
    <div class="quark-presence-container presence-block middle">
        ...
        <div class="quark-presence-column form-value">
            <textarea name="resume" class="editor-container"></textarea>
        </div>
    </div>
