...
echo $this->Fragment(new QuarkViewDialogFragment(
    'item-remove',
    'Delete news',
    'You are about to delete the news. This action cannot be undone. Continue?',
    'Please wait...',
    'The news was deleted',
    'An error occurred. Failed to delete the news',
    'Remove',
    'Close'
));
?>
...
<div class="quark-presence-column " id="content-container">
	<div class="quark-presence-container presence-block">
		<div class="quark-presence-column search-list">
			<select id="news-select" class="quark-input field-select"></select>
		</div>
		<div class="quark-presence-column search-list">
			<input type="text" class="quark-input search" name="news-search" placeholder="insert firsts letters of title wich you search">
		</div>
	</div>
	<div class="quark-presence-container presence-block main2 items-list" id="news-list">
		<div class="quark-presence-column" id="content-column">
			<div class="quark-presence-container presence-block" id="list-content">
				...
				<div id="item-title-date" class="quark-presence-column  content-titles dates">Publish Date</div>
