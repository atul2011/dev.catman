...
?>
<h1 class="page-title">Setting List</h1>
<h5 class="page-title">Navigate through settings</h5>
<div class="quark-presence-column left" id="content-container">
    <div class="quark-presence-container presence-block">
        ...
        <div class="quark-presence-column search-list">
            <input type="text" class="quark-input search" name="settings-search" placeholder="insert firsts letters of title wich you search">
        </div>
    </div>
    <div class="quark-presence-container presence-block main2 items-list" id="settings-list">
        <div class="quark-presence-column" id="content-column">
            <div class="quark-presence-container presence-block" id="list-content">
                ...
                <div id="setting_description" class="quark-presence-column  content-titles names">Description</div>
    ...
    <div class="quark-presence-container presence-block" id="list-options">
        ...
        <?php /* <div class="quark-presence-column right">
            <div class="quark-presence-container button-div" id="form-add-button">
                <div class="quark-presence-column right button-add-column" id="button-add-column">
                    <form action="/admin/settings/create" method="GET">
...
echo $this->Fragment(new QuarkViewDialogFragment(
	'item-remove',
	'Delete settings',
	'You are about to delete the setting. This action cannot be undone. Continue?',
	'Please wait...',
	'The term was deleted',
	'An error occurred. Failed to delete the setting',
	'Remove',
	'Close'
));
?>
